...
org.mate.panel.object applet-iid ''
...
# Add launcher to the panel. Remember to update the sed command below when adding/removing launchers.
gsettings set org.mate.panel object-id-list "$(gsettings get org.mate.panel object-id-list |sed "s/]/, 'cherrytree', 'sublime']/")"
